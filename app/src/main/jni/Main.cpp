...
// A64HookFunction 64bit

bool Istest = false;

bool (*old_test)(void *instance);
bool test(void *instance) {
...
void *hack_thread(void *) {
	...
	A64HookFunction((void *)getAbsoluteAddress("libil2cpp.so", 0x123456), (void *)test, (void **) &old_test);
...
JNICALL
Java_com_Ehromtj_NativeClass_EhromtjActivity_getFeatureList(JNIEnv *env, jobject context) {
    jobjectArray ret;

    const char *features[] = {
            OBFUSCATE("Category_The Category"), //Not counted
			OBFUSCATE("10_Toggle_Test 64bit"), // A64HookFunction 64bit
            ...
            OBFUSCATE("InputValue_2000_Input number"),//max value
            ...
            OBFUSCATE("Collapse_Settings"),
            OBFUSCATE("CollapseAdd_Category_Settings"),
            OBFUSCATE("-10_CollapseAdd_Toggle_True_Sounds"),
            OBFUSCATE("-1_CollapseAdd_Toggle_Save preferences"), //-1 is checked on Preferences.java
            
            OBFUSCATE("CollapseAdd_Category_Logcat"),
            OBFUSCATE("CollapseAdd_RichTextView_Save logcat if a bug occured and sent it to the modder. Clear logcat and reproduce bug again if the log file is too large"),
            OBFUSCATE("CollapseAdd_RichTextView_<small>Saving logcat does not need file permission. Logcat location:"
            ...
            OBFUSCATE("-4_CollapseAdd_Button_Save logcat to file"),
            OBFUSCATE("-5_CollapseAdd_Button_Clear logcat"),
    };
...
Java_com_Ehromtj_NativeClass_EhromtjPref_Changes(JNIEnv *env, jclass clazz, jobject obj,
